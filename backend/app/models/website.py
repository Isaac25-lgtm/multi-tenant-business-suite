...
class WebsiteSettings(db.Model):
    ...
    loan_interest_rate = db.Column(db.Numeric(5, 2), nullable=True, default=15)
    loan_interest_rate_label = db.Column(db.String(80), nullable=True, default='interest per month')
